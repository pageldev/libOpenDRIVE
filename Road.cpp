...
Point3D Road::get_refline_point(double s, double t)
{
    ...
    {
        std::map<double, std::shared_ptr<LaneOffset>>::iterator
    ...
    std::map<double, std::shared_ptr<RoadGeometry>>::iterator target_geom_iter =
    ...
    {
        std::map<double, std::shared_ptr<ElevationProfile>>::iterator

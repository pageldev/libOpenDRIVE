...
void ParamPoly3::update()
{
    ...
    a3 = 4 * cU * cU * h1 * h1 + 4 * cV * cV * h1 * h1 + 8 * bU * dU * h1 * h1 + 8 * bV * dV * h1 * h1 + 4 * cU * cU * h2 * h2 + 4 * cV * cV * h2 * h2 + 8 * bU * dU * h2 * h2 + 8 * bV * dV * h2 * h2;
    a4 = 10 * cU * dU * h1 * h1 + 10 * cV * dV * h1 * h1 + 10 * cU * dU * h2 * h2 + 10 * cV * dV * h2 * h2;
    a5 = 6 * dU * dU * h1 * h1 + 6 * dV * dV * h1 * h1 + 6 * dU * dU * h2 * h2 + 6 * dV * dV * h2 * h2;
